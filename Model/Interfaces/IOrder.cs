...
namespace Model.Interfaces
{
    public interface IOrder
    {
        ...
        Task<CanceledOrder> CancelOrder(string symbol, long? orderId = null);
        ...
        Task<NewOrder> OrderStopLossLimit(string symbol, decimal quantity, decimal stopLimitPrice, decimal stopPrice, OrderSide side);
